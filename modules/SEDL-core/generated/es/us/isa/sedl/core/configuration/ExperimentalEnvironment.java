 ...
 * 
 * 
 * <p>Clase Java para ExperimentalEnvironment complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ExperimentalEnvironment"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ExperimentalEnvironment")
@XmlSeeAlso({
    ComputationEnvironment.class,
    ...
    implements Cloneable, CopyTo, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ExperimentalEnvironment)) {
            return false;
        }
        if (this == object) {
            return true;
