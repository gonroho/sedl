 ...
 * 
 * <p>Clase Java para DifferentialHypothesis complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="DifferentialHypothesis"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "DifferentialHypothesis")
public class DifferentialHypothesis
    ...
    implements Cloneable, CopyTo, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DifferentialHypothesis)) {
            return false;
        }
        if (this == object) {
            return true;
