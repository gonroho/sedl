...
/**
 * <p>Clase Java para ComplexLog complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ComplexLog"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://isa.us.es/sedl/core/execution}Log"&gt;
 *       &lt;sequence&gt;
...
@XmlType(name = "ComplexLog", propOrder = {
    "lines"
})
    ...
    implements Cloneable, CopyTo, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ComplexLog)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final ComplexLog that = ((ComplexLog) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ComplexLog) {
            final ComplexLog copy = ((ComplexLog) draftCopy);
