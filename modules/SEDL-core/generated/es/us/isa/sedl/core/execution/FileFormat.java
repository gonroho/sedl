...
/**
 * <p>Clase Java para FileFormat complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="FileFormat"&gt;
 *   &lt;complexContent&gt;
    ...
    implements Cloneable, CopyTo, Equals, HashCode
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof FileFormat) {
            final FileFormat copy = ((FileFormat) draftCopy);
            if (this.encoding!= null) {
                String sourceEncoding;
                sourceEncoding = this.getEncoding();
                String copyEncoding = ((String) strategy.copy(LocatorUtils.property(locator, "encoding", sourceEncoding), sourceEncoding));
